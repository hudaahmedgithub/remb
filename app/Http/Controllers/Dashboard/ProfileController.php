...
class ProfileController extends Controller
{
	...
	public function orders()
	{
		...
		$orders=DB::table('Order_product')->leftJoin('musers','musers.id','=','Order_product.product_id')->leftJoin('orders','orders.id','=','Order_product.order_id')->where('orders.user_id','=',$user_id)->get();
