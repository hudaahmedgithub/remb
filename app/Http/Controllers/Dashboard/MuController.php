...
class MuController extends Controller
{
	...
	return
		view('admin.mu.index',compact('musers','categories','operations','countries'));
    }
    ...
    public function create()
    {
		...
		return view('admin.mu.create',compact('operations','categories','countries'));
    }
...
/*if($request->get('query'))
    ...
    public function edit($id)
    {
		...
		$operations=Operation::all();
		$countries=Country::all();
		return view('admin.mu.edit',compact('bu','categories','operations','countries'));
    }
   ...
   public function update(Request $request,Muser $bu , $id)
	...
	$request->validate([
	   ...
	   $bu->qty=$request->qty;
		...
		$bu->phone=$request->phone;
		$bu->save();
		return redirect()->route('dashboard.mu.index');
    }
