...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a class="active" href="{{route('dashboard.types.index')}}">@lang('site.types')</a></li>
        ...
        <div class="col-xs-10">
          <div class="box">
            <div class="box-header">
				<h3 class="box-title">@lang('site.types')  <small>   </small></h3>
				<form action="{{route('dashboard.types.index')}}" method="get">
					...
					<input type="search" class="col-md-4 form-control" placeholder="@lang('site.search')" name="search" value="{{request()->search}}" >
						...
						<a href="{{route('dashboard.types.create')}}" class="btn btn-warning">
							<i class="fa 
									  fa-plus"> @lang('site.add')</i>
						</a>
						
						@else
						<a href="{{route('dashboard.types.create')}}" class="btn btn-warning disabled">
							<i class="fa 
						  fa-plus">
								@lang('site.add')</i>
						</a>
                ...
                <tr>
                  ...
                  <td>
					 @if(auth()->user()->hasPermission('update_types'))
					  <a class="active btn btn-info" href="{{route('dashboard.types.edit',$cat->id)}}"><i class="fa 
					...
					@endif
					  ...
					  <form action="{{ route('dashboard.types.destroy', $cat->id) }}" method="post" style="display: inline-block">
                                                {{ csrf_field() }}
                                                {{ method_field('delete') }}
